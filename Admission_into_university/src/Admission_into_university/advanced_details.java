...
public class advanced_details implements ActionListener
{
	   JFrame jf4;
	   JButton jb1,jb2;
	   Variables_class a;
	   JTextField jtf1,jtf2;
	   advanced_details(Variables_class a)
	   {
		   this.a=a;
		   jf4 = new JFrame("advanced page");
		   jf4.setSize(700, 700);
		   ...
		   JLabel jl2 = new JLabel("JEE ADVANCED EXAM");
		   jl2.setFont(new Font("Serif",Font.BOLD,25));
		   jl2.setBounds(60, 60, 500, 60);
		   
		   JLabel jl3 = new JLabel("Advanced Exam Details...");
	...
	public void actionPerformed(ActionEvent ae) 
	{
		...
		{
			jf4.dispose();
			String advanced_application_no = jtf1.getText();
			a.setAdvanced_application_no(advanced_application_no);
			String advanced_rank = jtf2.getText();
		    a.setAdvanced_rank(advanced_rank);
			new advanced_branch_fee(a);
		}
		if(ae.getSource()==jb2)
		{
			new score_branch(a);
