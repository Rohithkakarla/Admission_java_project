...
public class eamcet_branch_fee implements ActionListener,ItemListener
{
	   Variables_class a;
	   JFrame jf1;
	   ...
	   int eamcet_rank;
   eamcet_branch_fee(Variables_class a)
   {
	   this.a =a;
		  jf1 = new JFrame("eamcet_branch page");
		  jf1.setSize(900, 900);
		  ...
		  try 
		  {
		      eamcet_rank = Integer.parseInt(a.eamcet_rank);
			  ...
			  if(eamcet_rank>1 && eamcet_rank<10000)
			  {
			  ...
			  else if(eamcet_rank>10001 && eamcet_rank<20000)
			  {
			  ...
			  else if(eamcet_rank>20001 && eamcet_rank<30000)
			  {
				  cse.setEnabled(false);
			  ...
			  else if(eamcet_rank>30001 && eamcet_rank<40000)
			  {
				  cse.setEnabled(false);
				  ece.setEnabled(false);
			  ...
			  else if(eamcet_rank>40001 && eamcet_rank<50000)
			  {
				  cse.setEnabled(false);
				  ece.setEnabled(false);
				  eee.setEnabled(false);
