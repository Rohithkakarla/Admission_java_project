...
public class advanced_branch_fee implements ActionListener,ItemListener
{
	  JFrame jf1;
	  ...
	  int var_advanced_rank;
	  Variables_class a;
	  
	  advanced_branch_fee(Variables_class a)
	  {
		  this.a =a;
		  jf1 = new JFrame("advanced_branch page");
		  jf1.setSize(900, 900);
		  ...
		  try 
		  {
		      var_advanced_rank = Integer.parseInt(a.advanced_rank);
			  ...
			  if(var_advanced_rank>1 && var_advanced_rank<10000)
			  {
			  ...
			  else if(var_advanced_rank>10001 && var_advanced_rank<20000)
			  {
			  ...
			  else if(var_advanced_rank>20001 && var_advanced_rank<30000)
			  {
				  cse.setEnabled(false);
			  ...
			  else if(var_advanced_rank>30001 && var_advanced_rank<40000)
			  {
				  cse.setEnabled(false);
				  ece.setEnabled(false);
			  ...
			  else if(var_advanced_rank>40001 && var_advanced_rank<50000)
			  {
				  cse.setEnabled(false);
				  ece.setEnabled(false);
				  eee.setEnabled(false);
	...
	public void actionPerformed(ActionEvent ae) 
	{
	   ...
	   if(ae.getSource()==cse)
	   {
		   a.branch = "Computer Science and Engineering";
