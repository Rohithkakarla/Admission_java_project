...
public class ipe_branch_fee implements ActionListener,ItemListener
{
	  JFrame jf1;
  ...
  ipe_branch_fee(Variables_class a)
  {
	  this.a =a;
	  jf1 = new JFrame("ipe_branch page");
	  jf1.setSize(900, 900);
	  ...
	  try 
	  {
	      ipe_total = Integer.parseInt(a.ipe_total);
		  ...
		  if(ipe_total>=990 && ipe_total<1000)
		  {
		  ...
		  else if(ipe_total>=980 && ipe_total<989)
		  {
		  ...
		  else if(ipe_total>970 && ipe_total<979)
		  {
			  cse.setEnabled(false);
		  ...
		  else if(ipe_total>960 && ipe_total<969)
		  {
			  cse.setEnabled(false);
			  ece.setEnabled(false);
		  ...
		  else if(ipe_total>950 && ipe_total<959)
		  {
			  cse.setEnabled(false);
			  ece.setEnabled(false);
			  eee.setEnabled(false);
...
public void actionPerformed(ActionEvent ae) 
{
   ...
   if(ae.getSource()==cse)
   {
       ...
       a.setBranch("Computer Science Engineering");
